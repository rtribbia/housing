...
var cap = function(url) {this.url = url; this.results = []; }

function scrapeListings(urls) {


	var outstandingRequests = 0;


	urls.forEach(function(listing, i) {
		outstandingRequests++;
...
cap.prototype.getResults = function() {
	return results;
}
